...
public class MapsActivity extends FragmentActivity {
    ...
    static final String SERVER_URL = "http://geofencing-sample.mybluemix.net";
    ...
    protected void onStart() {
        ...
        IntentFilter filter = new IntentFilter(MFGeofenceEvent.ACTION_GEOFENCE_EVENT);
    ...
    private void initManager() {
        ...
        manager = new MFGeofencingManager(this, SERVER_URL, USER, PWD, 10_000);
        manager.setIntervalBetweenDowloads(0);
     ...
     */
    void startSimulation(final List<MFGeofence> fences) {
     ...
     */
    void refreshGeofenceInfo(MFGeofence fence, boolean active) {
    ...
    void removeGeofence(MFGeofence fence) {
        String uuid = fence.getCode();
        GeofenceInfo info = geofenceInfoMap.get(uuid);
        if (info != null) {
            info.marker.remove();
     ...
     */
    Bitmap getOrCreateBitmap(MFGeofence fence, GeofenceInfo info) {
