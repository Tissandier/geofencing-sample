 ...
 */
public class MFGeofenceEvent {
    private static final String PREFIX = "com.ibm.mf.geofence.";
    /**
     * The name of the action used as the filter for geofence events delivered as intents.
     */
    public static final String ACTION_GEOFENCE_EVENT = PREFIX + "action.GEOFENCE_EVENT";
    /**
     * Key used to retrieve/store a list of geofences from/to an Intent's extras.
     */
    private static final String GEOFENCES_KEY = PREFIX + "geofences";
    /**
     * Key used to retrieve/store a list of deleted geofence codes from/to an Intent's extras.
     */
    private static final String DELETED_GEOFENCES_KEY = PREFIX + "deleted_geofences";
    /**
     * Key used to retrieve/store a type of geofence event from/to an Intent's extras.
     */
    private static final String EVENT_TYPE_KEY = PREFIX + "event_type";
    ...
    public enum Type {
         ...
         * "enter" and "exit" are used in the JSON payload when posting geoefence events to the backend server.
         */
        private String op;
     ...
     */
    private final List<MFGeofence> mGeofences;
    /**
     ...
     */
    private MFGeofenceEvent(final Type eventType, List<MFGeofence> geofences, final List<String> deletedGeofenceCodes) {
     ...
     * {@code getEventType() != IBMGeofenceEvent.Type.SERVER_SYNC}.
     */
     ...
     * </ul>
     * @return a list of {@link MFGeofence} objects, possibly {@code null}.
     */
    public List<MFGeofence> getGeofences() {
        return mGeofences;
    }
     ...
     * @return a {@code IBMGeofenceEvent} object populated from the intent.
     */
    public static MFGeofenceEvent fromIntent(Intent intent) {
        ...
        List<MFGeofence> geofences = null;
        ...
        if (codes != null) {
            ...
            geofences = PersistentGeofence.toMFGeofences(pgList);
        }
        ...
        return new MFGeofenceEvent(eventType, geofences, deletedCodes);
    }
