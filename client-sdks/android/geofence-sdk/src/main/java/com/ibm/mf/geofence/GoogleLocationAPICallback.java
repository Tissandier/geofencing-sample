...
class GoogleLocationAPICallback implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private final MFGeofencingManager mGeofencingService;
    private PendingIntent mPendingIntent = null;

    public GoogleLocationAPICallback(MFGeofencingManager geofencingService) {
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (mGeofencingService.mMode == MFGeofencingManager.MODE_APP) {
            mGeofencingService.loadGeofences();
        }
        if (mGeofencingService.mMode != MFGeofencingManager.MODE_REBOOT) {
