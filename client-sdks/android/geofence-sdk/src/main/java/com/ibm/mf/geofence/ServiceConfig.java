...
class ServiceConfig implements Serializable {
    ...
    private static final String PREFIX = "com.ibm.mf.sdk.";
    ...
    MFGeofenceEvent.Type mEventType;
    LatLng mNewLocation;
     ...
     */
    ServiceConfig fromGeofencingManager(MFGeofencingManager service) {
        HttpService httpService = service.mHttpService;
    ...
    public String toString() {
        return new StringBuilder(getClass().getSimpleName()).append('[')
            ...
            .append(", password=********") // never print the password!
    ...
    ServiceConfig fromIntent(Intent intent) {
        ...
        if (s != null) {
            try {
                mEventType = MFGeofenceEvent.Type.valueOf(s);
