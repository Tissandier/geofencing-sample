 ...
 */
public class JSONPayloadRequest extends HttpRequest<JSONObject> {
    /**
     ...
     */
    public JSONPayloadRequest(HttpRequestCallback<JSONObject> callback) {
     ...
     */
    public JSONPayloadRequest(HttpRequestCallback<JSONObject> callback, HttpMethod method, String payload) {
        super(callback, method, payload);
    }

    @Override
    protected JSONObject resultFromResponse(byte[] source) throws Exception {
