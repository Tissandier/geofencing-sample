...
public let kMFNetworkDidStartRequest = "com.ibm.NetworkDidStartRequest"
public let kMFNetworkDidEndRequest = "com.ibm.NetworkDidEndRequest"
...
public class NetworkActivityIndicatorManager: NSObject {
    ...
    public func enableActivityIndicator(enable:Bool) {
        if enable {
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NetworkActivityIndicatorManager.didStartRequest(_:)), name: kMFNetworkDidStartRequest, object: nil)
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(NetworkActivityIndicatorManager.didEndRequest(_:)), name: kMFNetworkDidEndRequest, object: nil)
        } else {
