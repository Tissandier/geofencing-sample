/**
 *  MFGeofence
 *  MFGeofenceCreateOperation.swift
 *
...
final class MFGeofenceCreateOperation:MFServiceOperation {
    ...
    init(service: MFService,geofenceName:String,geofenceDescription:String?,geofenceRadius:Int,geofenceCoordinate:CLLocationCoordinate2D) {
        ...
        self.name = "com.ibm.MF.GeofenceCreateOperation"
    }
