        ...
        didSet {
            if executing {
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    NSNotificationCenter.defaultCenter().postNotificationName(kMFNetworkDidStartRequest, object: self)
                }
            }
        }
    }
    ...
    override public var finished: Bool {
        willSet {
            if newValue && self.didStart {
                dispatch_async(dispatch_get_main_queue()) {
                    NSNotificationCenter.defaultCenter().postNotificationName(kMFNetworkDidEndRequest, object: self)
                }
            }
