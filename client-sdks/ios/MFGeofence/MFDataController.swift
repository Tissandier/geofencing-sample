...
public class MFDataController:NSObject {
    ...
    public var writerContext:NSManagedObjectContext  {
        ...
        synchronized {
            if self._writerContext == nil {
                ...
                NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(MFDataController.contextChanged(_:)), name: NSManagedObjectContextDidSaveNotification, object: self._writerContext)
            }
        }
